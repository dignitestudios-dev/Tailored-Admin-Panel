        ...
        <div className="flex items-start gap-2.5">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              Review reported records and track moderation status.
            </p>
          </div>
        </div>
      ...
      <Card className="max-w-sm border-0 bg-gradient-to-br from-white via-[#f6fbf8] to-[#ecf8f1] shadow-sm">
        ...
        <CardContent className="pt-0">
          {isLoading ? (
            ...
            <p className="text-xs text-muted-foreground">Pending reports queue</p>
          )}
        </CardContent>
      </Card>
                ...
                {isLoading ? (
                  ...
                  <TableRow>
                    <TableCell colSpan={9}>
                      <div className="flex flex-col items-center justify-center gap-2 py-14 text-center">
                        ...
                        <p className="text-xs text-muted-foreground">
                          No pending reports are available right now.
                        </p>
                      </div>
                    </TableCell>
                  </TableRow>
                  ...
                  reports.map((report) => (
                    <TableRow key={report.id}>
                      <TableCell className="font-medium">{toLabel(report.type)}</TableCell>
                      <TableCell className="max-w-[260px] truncate">
                        {report.reason ? truncateWords(report.reason) : "No reason provided"}
                      </TableCell>
                      <TableCell className="font-mono text-xs">{report.reportedBy}</TableCell>
                      <TableCell className="font-mono text-xs">{report.reported}</TableCell>
                      <TableCell>{report.targetModel}</TableCell>
                      <TableCell>
                        <Badge
                          variant="outline"
                          className={
            ...
            <div className="space-y-3 text-sm">
              ...
              <div className="space-y-2.5">
                ...
                <div className="flex items-center justify-between gap-3">
                  ...
                  <span className="font-mono text-xs">{selectedReport.reportedBy}</span>
                </div>
                <div className="flex items-center justify-between gap-3">
                  <span className="font-medium text-slate-700">Reported</span>
                  <span className="font-mono text-xs">{selectedReport.reported}</span>
                </div>
                <div className="flex items-center justify-between gap-3">
